<html>
	...
	<body id="otro">
		...
		<table id="principal">	
			...
			<%=request.getAttribute("arboles") %>
			<%=request.getAttribute("arbustos") %>
			<td><%=request.getAttribute("flores") %></td>
			<td><%=request.getAttribute("utiles") %></td>
			<td><%=request.getAttribute("mobiliario") %></td>
			<td><%=request.getAttribute("semillas") %></td>
